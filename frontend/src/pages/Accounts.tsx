  ...
  return (
    <Layout>
      ...
      <AddAccountModal
        ...
        onSave={(data) => {
          accountsDS.add(data as Parameters<typeof accountsDS.add>[0]);
          setAccounts(accountsDS.getAll());
...
function AddAccountModal({ isOpen, onClose, onSave }: { isOpen: boolean; onClose: () => void; onSave: (d: object) => void }) {
